        ...
        <CardContent className="grid gap-6">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input placeholder="https://example.com/photo.jpg" className="pl-10" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              />
              <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white mt-4" disabled={isLoading}>
