        ...
        <CardHeader className="bg-green-50/50 dark:bg-green-950/10 border-b">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
              <Sprout className="w-6 h-6 text-blue-700 dark:text-blue-400" />
            </div>
            <div>
              <CardTitle className="text-2xl font-bold">Update Your Tip</CardTitle>
              <CardDescription>Refine your gardening advice for the community.</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="pt-8">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Textarea 
                          placeholder="Update your gardening wisdom here..." 
              ...
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white h-12 font-bold text-lg" disabled={isLoading}>
